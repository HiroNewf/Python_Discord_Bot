...
8. Download the rockyou.txt wordlist from github and place it in the same directory as your bot.py file.
9. Make sure the 'Dog' folder and .json files are in the same directory as your bot.py file. 
